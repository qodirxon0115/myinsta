...
class SomoneProfilePage extends StatefulWidget {
  const SomoneProfilePage({Key? key}) : super(key: key);

  @override
  State<SomoneProfilePage> createState() => _SomoneProfilePageState();
}

class _SomoneProfilePageState extends State<SomoneProfilePage> {
